namespace BIA.ToolKit.Application.Helper.Option
{
    using System;
    ...
    public class OptionGeneratorHelper
    {
            ...
            InitializeSettings(List<ZipFeatureType> zipFeatureTypeList)
        {
            ...
            OptionGeneration optionHistory = CommonTools.DeserializeJsonFile<OptionGeneration>(optionHistoryFileName);
        ...
        /// </summary>
        public List<FeatureGenerationSettings> LoadFrontSettings(string biaFront, List<ZipFeatureType> zipFeatureTypeList)
        {
            var frontSettingsList = new List<FeatureGenerationSettings>();
        ...
        /// </summary>
        public OptionGenerationHistory LoadEntityHistory(OptionGeneration optionHistory, string entityPath)
        {
        ...
        /// </summary>
        public void UpdateHistory(OptionGeneration optionHistory, OptionGenerationHistory history)
        {
            try
            {
